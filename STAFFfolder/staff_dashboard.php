...
$fullName = $staff ? $staff['staff_fname']: "Staff";
$stmt->close();
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-footer bg-white border-0">
                                <a href="s_view_order.php" class="btn btn-sm w-100" style="background-color: #748DAE; border-color: #748DAE; color: white;">View Orders</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-footer bg-white border-0">
                                <a href="s_view_product.php" class="btn btn-sm w-100" style="background-color: #437057; border-color: #437057; color: white;">Browse Products</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-footer bg-white border-0">
                                <a href="s_view_product.php" class="btn btn-sm w-100" style="background-color: #A34343; border-color: #A34343; color: white;">Browse Products</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-footer bg-white border-0">
                                <a href="s_distributor_list.php" class="btn btn-sm w-100" style="background-color: #DA8359; border-color: #DA8359; color: white;">View Distributor List</a>
                            </div>
