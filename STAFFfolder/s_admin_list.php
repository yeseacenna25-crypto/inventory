...
$sql = "SELECT admin_id, admin_fname, admin_mname, admin_lname, admin_extension, admin_address, admin_outlet, admin_contact_number, admin_email, admin_username FROM admin_signup WHERE 1=1";
if (!empty($search)) {
...
<html lang="en">
          ...
          <tbody>
              ...
              <?php else: ?>
                ...
                <tr>
                  ...
                  <td>
                     <?php if (!isset($_SESSION['staff_id']) || $admin['admin_id'] != $_SESSION['staff_id']): ?>
  ...
  // Fetch admin details
  fetch('s_get_admin_details.php?admin_id=' + adminId)
      ...
      function editAdmin(adminId) {
        window.location.href = 's_edit_universal_profile.php?type=admin&id=' + adminId;
      }
